...
final authUserPostsProvider = StreamProvider.autoDispose<Iterable<Post>>((ref) {
...
final userPostsProvider = StreamProvider.family.autoDispose<Iterable<Post>, UserId>((ref, UserId userId) {
  final controller = StreamController<Iterable<Post>>();
